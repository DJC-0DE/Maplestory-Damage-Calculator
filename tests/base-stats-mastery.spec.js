...
test.describe("Base Stats - Mastery Bonus Tables", () => {
  ...
  test.describe("3rd Job Mastery Table", () => {
    test("3rd job mastery table is visible when 3rd tier selected", async ({
      page,
    }) => {
    ...
    test("checking 3rd job all-monster level 64 mastery updates state", async ({
      page,
    }) => {
      // Act
      ...
      const skillMastery = await page.evaluate(
    ...
    test("checking 3rd job all-monster level 68 mastery accumulates bonus", async ({
      page,
    }) => {
    ...
    test("checking 3rd job boss-only level 72 mastery updates boss bonus", async ({
      page,
    }) => {
      // Act
      ...
      const skillMasteryBoss = await page.evaluate(
    ...
    test("checking 3rd job all-monster level 76 mastery accumulates correctly", async ({
      page,
    }) => {
    ...
    test("checking 3rd job all-monster level 80 mastery updates bonus", async ({
      page,
    }) => {
      // Arrange
      await page.check(MASTERY_3RD_CHECKBOXES.all64);
    ...
    test("checking 3rd job boss-only level 84 mastery updates boss bonus", async ({
      page,
    }) => {
      // Arrange
      await page.check(MASTERY_3RD_CHECKBOXES.boss72);
    ...
    test("checking 3rd job all-monster level 88 mastery accumulates", async ({
      page,
    }) => {
    ...
    test("checking 3rd job all-monster level 92 mastery completes all 3rd job bonuses", async ({
      page,
    }) => {
      // Arrange - Check all previous all-monster masteries
      await page.check(MASTERY_3RD_CHECKBOXES.all64);
    ...
    test("unchecking 3rd job mastery removes bonus", async ({ page }) => {
      ...
      // Assert
      await expect(
        page.locator(MASTERY_3RD_CHECKBOXES.all68),
      ).not.toBeChecked();
  ...
  test.describe("4th Job Mastery Table", () => {
    ...
    test("4th job mastery table is visible when 4th tier selected", async ({
      page,
    }) => {
      // Assert
    ...
    test("checking 4th job all-monster level 102 mastery updates state", async ({
      page,
    }) => {
      // Act
    ...
    test("checking 4th job all-monster level 106 mastery accumulates", async ({
      page,
    }) => {
      // Arrange
      await page.check(MASTERY_4TH_CHECKBOXES.all102);
    ...
    test("checking 4th job boss-only level 111 mastery updates boss bonus", async ({
      page,
    }) => {
      // Act
    ...
    test("checking 4th job all-monster level 116 mastery accumulates", async ({
      page,
    }) => {
      // Arrange
      await page.check(MASTERY_4TH_CHECKBOXES.all102);
    ...
    test("checking 4th job all-monster level 120 mastery accumulates", async ({
      page,
    }) => {
      // Arrange
      await page.check(MASTERY_4TH_CHECKBOXES.all102);
    ...
    test("checking 4th job boss-only level 124 mastery updates boss bonus", async ({
      page,
    }) => {
      // Arrange
      await page.check(MASTERY_4TH_CHECKBOXES.boss111);
    ...
    test("checking 4th job all-monster level 128 mastery accumulates", async ({
      page,
    }) => {
    ...
    test("checking 4th job all-monster level 132 mastery completes all 4th job bonuses", async ({
      page,
    }) => {
      // Arrange - Check all previous
      await page.check(MASTERY_4TH_CHECKBOXES.all102);
    ...
    test("unchecking 4th job mastery removes bonus", async ({ page }) => {
      ...
      // Assert
      await expect(
        page.locator(MASTERY_4TH_CHECKBOXES.all106),
      ).not.toBeChecked();
  ...
  test.describe("Job Tier Switching with Mastery", () => {
    test("switching from 3rd to 4th job preserves 3rd job mastery", async ({
      page,
    }) => {
      ...
      const jobTier = await page.evaluate(() =>
        localStorage.getItem("selectedJobTier"),
      );
      expect(jobTier).toBe("3rd");
    });

    test("switching job tiers updates mastery tabs in sync", async ({
      page,
    }) => {
  ...
  test.describe("Mastery with Fixture Application", () => {
    test("applying fixture configures mastery checkboxes correctly", async ({
      page,
    }) => {
