...
export const slotSpecificPotentials = {
  cape: {
    epic: {
    ...
    unique: {
      ...
      line2: [
        { stat: "Final Damage %", value: 5, weight: 0.24, prime: true },
        { stat: "Final Damage %", value: 3, weight: 0.76, prime: false },
      ],
      line3: [
        { stat: "Final Damage %", value: 5, weight: 0.08, prime: true },
        { stat: "Final Damage %", value: 3, weight: 0.92, prime: false },
      ],
    },
    legendary: {
      line1: [{ stat: "Final Damage %", value: 8, weight: 1, prime: true }],
      line2: [
        { stat: "Final Damage %", value: 8, weight: 0.24, prime: true },
        { stat: "Final Damage %", value: 5, weight: 0.76, prime: false },
      ],
      line3: [
        { stat: "Final Damage %", value: 8, weight: 0.08, prime: true },
        { stat: "Final Damage %", value: 5, weight: 0.92, prime: false },
      ],
    },
    mystic: {
      line1: [{ stat: "Final Damage %", value: 12, weight: 1, prime: true }],
      line2: [
        { stat: "Final Damage %", value: 12, weight: 0.24, prime: true },
        { stat: "Final Damage %", value: 8, weight: 0.76, prime: false },
      ],
      line3: [
        { stat: "Final Damage %", value: 12, weight: 0.08, prime: true },
        { stat: "Final Damage %", value: 8, weight: 0.92, prime: false },
      ],
    },
  },
  gloves: {
    epic: {
      ...
      line2: [
        { stat: "Critical Damage %", value: 10, weight: 0.24, prime: true },
      ],
      line3: [
        { stat: "Critical Damage %", value: 10, weight: 0.08, prime: true },
      ],
    },
    unique: {
      line1: [{ stat: "Critical Damage %", value: 20, weight: 1, prime: true }],
      line2: [
        { stat: "Critical Damage %", value: 20, weight: 0.24, prime: true },
        { stat: "Critical Damage %", value: 10, weight: 0.76, prime: false },
      ],
      line3: [
        { stat: "Critical Damage %", value: 20, weight: 0.08, prime: true },
        { stat: "Critical Damage %", value: 10, weight: 0.92, prime: false },
      ],
    },
    legendary: {
      line1: [{ stat: "Critical Damage %", value: 30, weight: 1, prime: true }],
      line2: [
        { stat: "Critical Damage %", value: 30, weight: 0.24, prime: true },
        { stat: "Critical Damage %", value: 20, weight: 0.76, prime: false },
      ],
      line3: [
        { stat: "Critical Damage %", value: 30, weight: 0.08, prime: true },
        { stat: "Critical Damage %", value: 20, weight: 0.92, prime: false },
      ],
    },
    mystic: {
      line1: [{ stat: "Critical Damage %", value: 50, weight: 1, prime: true }],
      line2: [
        { stat: "Critical Damage %", value: 50, weight: 0.24, prime: true },
        { stat: "Critical Damage %", value: 30, weight: 0.76, prime: false },
      ],
      line3: [
        { stat: "Critical Damage %", value: 50, weight: 0.08, prime: true },
        { stat: "Critical Damage %", value: 30, weight: 0.92, prime: false },
      ],
    },
  },
  legs: {
  ...
  shoulder: {
    unique: {
      line1: [
        { stat: "Defense Penetration", value: 8, weight: 1, prime: true },
      ],
      line2: [
        { stat: "Defense Penetration", value: 8, weight: 0.24, prime: true },
      ],
      line3: [
        { stat: "Defense Penetration", value: 8, weight: 0.08, prime: true },
      ],
    },
    legendary: {
      line1: [
        { stat: "Defense Penetration", value: 12, weight: 1, prime: true },
      ],
      line2: [
        { stat: "Defense Penetration", value: 12, weight: 0.24, prime: true },
        { stat: "Defense Penetration", value: 8, weight: 0.76, prime: false },
      ],
      line3: [
        { stat: "Defense Penetration", value: 12, weight: 0.08, prime: true },
        { stat: "Defense Penetration", value: 8, weight: 0.92, prime: false },
      ],
    },
    mystic: {
      line1: [
        { stat: "Defense Penetration", value: 20, weight: 1, prime: true },
      ],
      line2: [
        { stat: "Defense Penetration", value: 20, weight: 0.24, prime: true },
        { stat: "Defense Penetration", value: 12, weight: 0.76, prime: false },
      ],
      line3: [
        { stat: "Defense Penetration", value: 20, weight: 0.08, prime: true },
        { stat: "Defense Penetration", value: 12, weight: 0.92, prime: false },
      ],
    },
  },
};
...
// Rankings pagination
export const rankingsPerPage = 25;
...
export const equipmentPotentialData = {
  normal: {
    line1: [
